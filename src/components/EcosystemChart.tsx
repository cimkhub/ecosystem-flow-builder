...
export default function EcosystemChart() {
  ...
  const getSizeClasses = (size: 'small' | 'medium' | 'large') => {
    switch (size) {
      case 'small': return { container: 'col-span-1 max-w-lg', width: 'w-96', height: 'min-h-80' };
      case 'medium': return { container: 'col-span-1 max-w-xl', width: 'w-[28rem]', height: 'min-h-96' };
      case 'large': return { container: 'col-span-1 lg:col-span-2 max-w-2xl', width: 'w-[32rem]', height: 'min-h-[28rem]' };
      default: return { container: 'col-span-1 max-w-xl', width: 'w-[28rem]', height: 'min-h-96' };
    }
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <ScrollArea className="h-[80vh] w-full rounded-2xl">
        <div
          ref={chartRef}
                            ...
                            {subcategory.companies.map((company, companyIndex) => (
                              ...
                              >
                                {company.logoUrl ? (
                                  ...
                                  <div className={`mb-3 ${customization.size === 'small' ? 'w-8 h-8' : customization.size === 'large' ? 'w-12 h-12' : 'w-10 h-10'} bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex items-center justify-center`}>
                                    <span className={`${customization.size === 'small' ? 'text-sm' : customization.size === 'large' ? 'text-lg' : 'text-base'} font-semibold text-gray-600`}>
